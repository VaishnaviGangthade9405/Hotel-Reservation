...
<head><!--Head Open  Here-->
  ...
  <link rel="icon" href="./logo/logo3.png" type="image/ico">
...
<div class="container text-center">    
  <h1 style=" font-family: 'Dancing Script', cursive;color:white  ; font-weight:bold;font-size:50px; padding:15px; position: relative; bottom: 390px; filter:drop-shadow(10px 2px 4px rgb(129, 94, 5)); letter-spacing:3px;">Welcome To  Royal Hotel<br><br><p style="font-size:35px;"></p></h1><br>
  <div class="row">
